        ...
        <article className='rounded-md overflow-hidden mx-1'>
            ...
            }
            {
                ...
                src && <section className='rounded shadow-md mx-auto'>
                    <Link href={model.base_model ? "/collections/" + model.spec_name : "/collections/" + model.spec_name + `?annotation=${model.uid}`} tabIndex={-1} aria-label={`Go to 3D Model of ${model.spec_name}`}>
                        <img
