...
export default function ThumbnailPreviewModal(props: { path: string | null | undefined, isOpen: boolean, setIsOpen: Dispatch<SetStateAction<boolean>>, species: string }) {
    const path = props.path ? isLocalDevEnvClient() ? convertDbPathToLocalPath(props.path) : `public/data/Vertebrates/Thumbnails/ee451c036e3d45398f8a1f2ad78367c3/testPhoto.png` : null
    console.log(path)
